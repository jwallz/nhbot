...
CREATE TABLE IF NOT EXISTS municipality (
    ...
    aland_sqmi   numeric,
    awater_sqmi  numeric,
    centroid     geometry(Point, 4326),           -- Census internal point; boundary polygons land later (GRANIT)
...
CREATE INDEX IF NOT EXISTS municipality_centroid_gix ON municipality USING gist(centroid);
CREATE INDEX IF NOT EXISTS municipality_boundary_gix ON municipality USING gist(boundary);
